...
public class GamePlay extends javax.swing.JFrame
{
    ...
    static void GamePlay_RestartBtn() {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(246, 239, 218));
        ...
        UndoBtn.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 18));
        ...
        jPanel3.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(246, 239, 218), 8, true));
    ...
    private void upBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_upBtnActionPerformed
        ...
        delay();
            ...
            score= Long.parseLong(scoreLabel.getText());
         try
    {


       Class.forName("java.sql.DriverManager");
       Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/project12","root","123");
       Statement stmt =(Statement)con.createStatement();


           String query2="Select hsc from HScore where rank = 1;";
           ResultSet rs = stmt.executeQuery(query2);
           if(rs.next())
           hscore=Long.parseLong(rs.getString("hsc"));
           if(score>hscore)
           {
               hscore=score;
               highScoreLabel.setText(""+hscore);
               if(hscFlag==0)
               {
       ...
       String query3="Update HScore set hsc = "+hscore+" where rank = 1;";
    ...
    for(int i=0;i<=3;i++)
   {
       for(int j=0;j<=3;j++)
       {
           ...
           String query="Select Previous from Saved_Game where jLabelNo = 'sc';";
           ResultSet rs = stmt.executeQuery(query);
           if(rs.next())
           score=Long.parseLong(rs.getString("Previous"));
...
while(true)
{
   ...
   colourAssign();
    ...
    public javax.swing.JButton UndoBtn;
